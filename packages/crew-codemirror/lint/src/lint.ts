import {EditorView, ViewPlugin, Decoration, DecorationSet,
        ...
        PanelConstructor, Panel, showPanel, getPanel, activateHover} from "@codemirror/view"
...
export const previousDiagnostic: Command = (view: EditorView) => {
  ...
  let from = prevFrom ?? lastFrom, to = prevTo ?? lastTo ?? from
...
const lintGutterTheme = EditorView.baseTheme({
  ...
  ".cm-lint-marker-info": {
    content: svg(`<path fill="#aaf" stroke="#77e" stroke-width="6" strokeLinejoin="round" d="M5 5L35 5L35 35L5 35Z"/>`)
  },
  ".cm-lint-marker-warning": {
    content: svg(`<path fill="#fe8" stroke="#fd7" stroke-width="6" strokeLinejoin="round" d="M20 6L37 35L3 35Z"/>`),
  },
...
const lintHover = hoverTooltip(lintTooltip, {hideOn: hideTooltip})
